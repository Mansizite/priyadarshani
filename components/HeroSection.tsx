...
//           Welcome to <br />
//           <span className={styles.highlight}>Priyadarshani High  School Bhosari </span>
//         </h1>
//            <p className={styles.sinceBadge}>Since 1982</p>
    ...
    <section id="home" className={styles.heroSection}>
      ...
      <div className={styles.content}>
        <div className={styles.badgeContainer}>
          <span className={styles.sinceBadge}>Since 1982</span>
        </div>
        <h1 className={styles.title}>
          Welcome to <br />
          <span className={styles.highlight}>Priyadarshani High School Bhosari</span>
